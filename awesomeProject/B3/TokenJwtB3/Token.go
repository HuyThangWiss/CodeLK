...
func NewJWTServiceB3() *jwtService {
	return &jwtService{
...
func (jwtSrv *jwtService) GenerateTokenB3(Masv string, Passwordsv string) string {
...
func (jwtSrv *jwtService) ValidateTokenB3(tokenString string) (*jwt.Token, error) {
